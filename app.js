(function () {
  var checklistKey = "okinawa-checklist";
  var noteKey = "okinawa-note";
  ...
  function renderHome() {
    ...
    return '<div class="view">' +
      '<section class="hero"><p class="kicker">OKINAWA 5D4N</p><h1>Trip<br>Control</h1><p class="lead">打開就知道今天去哪、下一站怎麼導航、還有什麼東西沒確認。桌機和手機同一套操作。</p><div class="action-row"><a class="action primary" target="_blank" href="' + directions(day.stops) + '">今日路線導航</a><button class="action" data-view="itinerary">看今日行程</button></div></section>' +
